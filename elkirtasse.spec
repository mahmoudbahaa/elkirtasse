...
%description
  Library elkietasse free program is open source foe all operating systems running Linux or Windows or Mac lets you view and edit books and you can add news books ,http://www.elkirtasse.co.cc,
...
Name=elkirtasse
Name[ar]=القرطاس 
Comment[ar]=مكتبة القرطاس برنامج مجاني مفتوح تعمل على جميع أنظمة التشغيل لينكس او وندوز أو ماك تتيح لك مطالعة الكتب و تحريرها كما يمكنك إضافة كتب جديدة
Type=Application
Exec=elkirtasse
Icon=elkirtasse
Categories=Office;
